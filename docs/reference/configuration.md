...
Public catalog used by Theme Manager and Plugins (`Add from MKSine`). The panel fetches JSON from the official site, then downloads the listing ZIP onto **this** MKSine install.
