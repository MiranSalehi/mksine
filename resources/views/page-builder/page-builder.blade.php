...
>
    <div class="mksine-page-builder flex h-full min-h-0 flex-col" wire:ignore.self>
        ...
        <div class="flex min-h-0 flex-1">
            ...
            @include('mksine::page-builder.components.sidebar', [
                'categoryDisplayMeta' => $this->categoryDisplayMeta,
                'insertAtPosition' => $insertAtPosition ?? null,
                'insertInParent' => $insertInParent ?? null,
                'insertInColumn' => $insertInColumn ?? null,
            ])
        </div>
    </div>
