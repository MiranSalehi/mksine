        ...
        <div class="bg-white border-b border-gray-200">
            <div class="container mx-auto max-w-6xl px-4 py-3">
                <div class="text-sm text-gray-600">
                    ...
                    <span class="text-gray-800">{{ __('Author') }}: {{ $author->name }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto max-w-6xl px-4 py-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                <div class="bg-white p-6 rounded-lg shadow text-center">
                    <div class="text-3xl font-bold text-pink-500 mb-2">{{ $posts->total() }}</div>
                    <p class="text-gray-600">{{ __('Articles') }}</p>
                </div>
            </div>

            <!-- Articles Section -->
            <section>
                <h2 class="text-3xl font-bold text-gray-800 mb-8">{{ $author->name }}'s {{ __('Articles') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    ...
                    @empty
                        <p class="text-gray-500 col-span-full">{{ __('No articles yet.') }}</p>
                    @endforelse
                </div>
