<div>
        ...
        <div class="container mx-auto max-w-6xl px-4 py-3">
            <div class="text-sm text-gray-600 dark:text-gray-400 flex flex-wrap items-center gap-x-2 gap-y-1">
                ...
                @foreach($categoryPath as $cat)
                    ...
                    <a href="{{ $cat->getUrl() }}" class="text-pink-500 hover:text-pink-600">{{ $cat->name }}</a>
                @endforeach
    ...
    <div class="container mx-auto max-w-4xl px-4 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <article class="lg:col-span-2">
                ...
                <div class="bg-gray-100 p-6 rounded-lg mb-8">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="https://www.instagram.com/share?url={{ urlencode(route('posts.show', $post->slug)) }}" class="bg-pink-500 text-white px-4 py-2 rounded hover:bg-pink-600 transition">Instagram</a>
                ...
                <div class="bg-white border-2 border-gray-200 p-6 rounded-lg mb-8">
                    ...
                    <div class="flex gap-4">
                        ...
                        @else
                            <div class="w-20 h-20 rounded-full bg-pink-100 flex items-center justify-center text-2xl font-bold text-pink-600">
                        ...
                        <div>
                            ...
                            @endif
                            <a href="{{ route('authors.show', $post->author->id) }}" class="text-pink-500 hover:text-pink-600 font-semibold text-sm">{{ __('View All Articles by This Author') }}</a>
                        </div>
                    </div>
                </div>
            ...
            <aside class="lg:col-span-1">
                ...
                <div class="bg-white p-6 rounded-lg shadow mb-6">
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="#" class="text-pink-500 hover:text-pink-600 font-semibold">Treatment of Bone Fractures</a>
                            <p class="text-xs text-gray-500 mt-1">December 3, 2023</p>
                        </li>
                        <li>
                            <a href="#" class="text-pink-500 hover:text-pink-600 font-semibold">Best Exercises for Health</a>
                            <p class="text-xs text-gray-500 mt-1">December 1, 2023</p>
                        </li>
                        <li>
                            <a href="#" class="text-pink-500 hover:text-pink-600 font-semibold">Balanced Diet Guide</a>
                ...
                <div class="bg-white p-6 rounded-lg shadow mb-6">
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-pink-500 hover:text-pink-600">Medicine (24)</a></li>
                        <li><a href="#" class="text-pink-500 hover:text-pink-600">Nutrition (18)</a></li>
                        <li><a href="#" class="text-pink-500 hover:text-pink-600">Exercise (15)</a></li>
                        <li><a href="#" class="text-pink-500 hover:text-pink-600">Beauty (12)</a></li>
                    </ul>
                </div>
                ...
                <div class="bg-gradient-to-r from-pink-500 to-red-400 text-white p-6 rounded-lg shadow">
                    ...
                    <p class="text-sm mb-4">Get the Latest Updates</p>
                    <form class="space-y-3">
                        <input type="email" placeholder="Email" class="w-full px-3 py-2 rounded text-gray-800 focus:outline-none text-sm">
                        <button type="submit" class="w-full bg-white text-pink-500 px-3 py-2 rounded font-semibold hover:bg-pink-50 transition text-sm">Subscribe</button>
                    </form>
                </div>
            </aside>
        </div>
        ...
        <section class="mt-16">
            <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-8">{{ __('Related Articles') }}</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article class="rounded-lg overflow-hidden shadow hover:shadow-lg transition bg-white dark:bg-gray-800">
                    <a href="{{ route('posts.show', $related->slug) }}" class="block">
                        <div class="h-48 bg-gradient-to-br from-orange-300 to-orange-400 dark:from-orange-600 dark:to-orange-700 flex items-center justify-center overflow-hidden">
                        ...
                        <div class="p-4 bg-white dark:bg-gray-800">
                            ...
                            <div class="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400">
                                <span><a href="{{ route('authors.show', $related->author->id) }}" class="hover:text-pink-500 text-gray-600 dark:text-gray-400" onclick="event.stopPropagation();">{{ __('Author') }}: {{ $related->author->name }}</a></span>
