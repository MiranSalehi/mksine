    ...
    <div class="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            >
                ...
                >{{ __('mksine::frontend.home_finance_showcase_heading_accent') }}</span
                >{{ __('mksine::frontend.home_finance_showcase_heading_suffix') }}
            </h2>
            ...
            <div class="mt-6 space-y-4 text-pretty text-base leading-relaxed text-gray-600 md:text-lg dark:text-gray-400">
                <p>
                    ...
                    >{{ __('mksine::frontend.home_finance_showcase_p1_highlight') }}</span
                    >{{ __('mksine::frontend.home_finance_showcase_p1_after') }}
                </p>
                <p>
                    {{ __('mksine::frontend.home_finance_showcase_p2_before') }}<span
                        class="font-semibold text-orange-600 dark:text-orange-400"
                    >{{ __('mksine::frontend.home_finance_showcase_p2_highlight') }}</span
                    >{{ __('mksine::frontend.home_finance_showcase_p2_after') }}
                </p>
            </div>
        ...
        >
            ...
            >
                ...
                <div class="space-y-2">
                    ...
                    <div class="h-16 rounded-lg bg-gradient-to-r from-violet-100 to-indigo-100 dark:from-violet-900/40 dark:to-indigo-900/40"></div>
                    <div class="flex items-end gap-1">
                        @for ($b = 0; $b < 6; $b++)
                            <div
                                class="h-10 flex-1 rounded bg-violet-200/80 dark:bg-violet-800/50"
                                style="height: {{ 28 + ($b * 6) }}px; margin-top: auto"
                            ></div>
                        @endfor
                    </div>
                </div>
