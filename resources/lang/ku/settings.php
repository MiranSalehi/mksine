...
return [
    ...
    'front_page_helper' => 'هەڵبژێرە کامی پەڕە وەک سەرەتای ماڵپەڕ پیشان دەدرێت. بەتاڵ بەجێبهێڵە بۆ پەڕەی بنەڕەتی (placeholder).',
    'front_page_default' => 'بنەڕەتی (پەڕەی placeholder)',
    ...
    'tags_url' => 'URLی تاگەکان',
    'single_tag_url' => 'URLی تاگی تاک',
    'single_tag_url_helper' => '{slug} بەکاربهێنە بۆ جێگرەوەی slugی تاگ',
